...
function tip_out()
{
	...
	if (co == 0)
	{
		...
		{
			document.write("<h2 id='titulo'>" + tl_1 + "</h2>");
			document.getElementById('titulo').style.fontSize='20px';
			document.getElementById('titulo').style.fontFamily='Hind Siliguri, sans-serif';

			if (b_q == 1) document.write('<b>',"<h4>" + od + "</h4>", '</b>');
			
			else document.write(od);
			
			document.write("<h2 id='bajada'>" + tl_2 + "</h2>");
			document.getElementById('bajada').style.fontFamily='Hind Siliguri, sans-serif';
			document.getElementById('bajada').style.fontSize='16px';
...
{	
	...
	document.write("<h4 id='textBajada'>" + tl_11 + "</h4>");
	document.getElementById('textBajada').style.fontFamily='Hind Siliguri, sans-serif';
}
